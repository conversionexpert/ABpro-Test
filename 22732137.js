	  			  		...
	  			  		function(){
	  						...
	  						var variationId = User.getVariationIdOfExperimemt(experiment);	
	  			  			...
	  			  			Project.data.exclusion_groups.forEach(function(exclusionGroup){
	  			  				...
	  			  				//User is already bucketed and not excluded (means user has a correct Variation ID for this Experiment => not FALSE and not 0)
	  			  				if(variationId){
	  			  					//exclusionGroupPickedExperimentId = 
	  			  				}
	  			  				
	  			  				
	  			  				console.log( User.experimentsBucket );
