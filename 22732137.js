...
//    		}
    ...
    Experiment.prototype.passesExclusionGroups = function(){
		...
		Project.data.exclusion_groups.forEach(function(exclusionGroup){
			...
			exclusionGroup.exclusion_group_entries.forEach(function(exclusionGroupEntry){
