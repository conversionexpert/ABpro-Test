		...
		Project.data.exclusion_groups.forEach(function(exclusionGroup){
			...
			if(!exclusionGroupPickedExperimentId){
		    	...
		    	var dicedExperimentId = false;  			
		  		...
		  		//Fill to 100
		  		//var missingPercentPoints = 100 - experimentsDicerArr.length;
		  		
		  		//console.log( missingPercentPoints );
		  		
		  		while(experimentsDicerArr.length < 100){
		  			experimentsDicerArr.push(false);
		  		}
		  		console.log( experimentsDicerArr );
