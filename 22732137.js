...
(function(){
	...
	var Script = {
		...
		carriesExperiment: function(experimentId){
			
			console.log( this.projectData.experiments );
	  			  		...
	  			  		function(){
	  			  			...
	  			  			Project.data.exclusion_groups.forEach(function(exclusionGroup){
		  			  			...
		  			  			for(var experimentsBucketExperimentId in User.experimentsBucket){
		  			  				...
		  			  				Script.carriesExperiment( experimentsBucketExperimentId );
