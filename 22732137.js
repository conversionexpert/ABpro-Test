	  					...
	  					function(){
	  			  		...
	  			  		function(){
	  			  			...
	  			  			if(!Script.isPreview){
	  			  				...
	  			  				console.log(experiment.data.id, experiment.passesExclusionGroups());
