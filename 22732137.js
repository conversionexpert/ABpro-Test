...
(function(){
	...
	var Script = {
		...
		carriesExperiment: function(experimentIdNeedle){
			var experiments = this.projectData.experiments;
			for(var index in experiments){
				
				console.log(experiments[index].id, experimentIdNeedle);
				
				if(experiments[index].id === experimentIdNeedle){
					return true;
				}
			}
			return false;
	  			  		...
	  			  		function(){
	  			  			...
	  			  			Project.data.exclusion_groups.forEach(function(exclusionGroup){
		  			  			...
		  			  			for(var experimentsBucketExperimentId in User.experimentsBucket){
		  			  				...
		  			  				/*
		  			  				 * Check if...
		  			  				 * - the Experiment is still (active) in the Snippet
		  			  				 * - the User is already bucketed in this Experiment
		  			  				 * - the User wasnt excluded => VariationId = 0
		  			  				 */
		  			  				...
		  			  				//console.log( Project.data.experiments );
...
//		  							if(User.experimentsBucket[experimentsBucketExperimentId] === 0){
//		  								//
//		  							}
